...
- consiglio scarpe uomo --> **general**
  scrivi un codice Python che calcola il TFR rispettando il D.Lgs. 47/2000 e dimostra la formula matematica --> **query con 3 domini possibili**
...
- codice C++ calcolo traiettoria proiettile --> **math->coding**
...
- quante piastrelle servono per 12 m^2? --> **general**
