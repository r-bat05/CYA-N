...
INTENT_SENTENCES: Dict[str, List[str]] = {
    'coding': [
        ...
        # --- Short-form queries (P2 fix: anti-degradazione general) ---
        "codice Python lista ordinata",
        "funzione JavaScript async await",
        "query SQL join tabelle",
        "script bash loop su file",
        "React component con hooks",
        "Docker container per app Python",
        "API REST con Flask Python",
        "risolvi merge conflict git",
        "regex validazione email Python",
        "unit test con pytest",
        "classe Python con ereditarietà",
        "query aggregation MongoDB",
        "server Node.js con Express",
        "div centrato con CSS flexbox",
        "gestione eccezioni Python try catch",
        "prevenzione SQL injection query parametrizzata",
        "pipeline CI/CD con GitHub Actions",
        "caching Redis con Python",
        "filtra colonne DataFrame pandas",
        "lambda function Python esempio pratico",
        "leggi stack trace eccezione Java",
        "WebSocket server Python aiohttp",
        "autenticazione JWT token Python",
        "Dockerfile multi-stage ottimizzato",
        "trova processi attivi Linux comando",
        "scrivi funzione ricorsiva Python",
        "ordina dizionario Python per valore",
        "connessione database PostgreSQL Python",
        "parsing JSON Python requests",
        "decoratore Python esempio semplice",
        "thread pool executor Python",
        "context manager Python with statement",
        "generator function Python yield",
        "list comprehension Python filtro",
        "binary search implementazione Python",
        "hash map collision handling Python",
    ],
    ...
    'math': [
        ...
        # --- Short-form queries (P2 fix: anti-degradazione general) ---
        "calcola integrale definito seno",
        "derivata funzione esponenziale",
        "autovalori matrice 3x3",
        "limite forma indeterminata L'Hopital",
        "risolvi sistema lineare Gauss-Jordan",
        "probabilità distribuzione binomiale",
        "sviluppo serie Taylor",
        "equazione differenziale secondo ordine",
        "prodotto vettoriale spazio R3",
        "teorema Bayes probabilità condizionata",
        "rango matrice al variare di parametro",
        "funzione continua e derivabile studio",
        "integrale doppio cambio coordinate",
        "test ipotesi t-student p-value",
        "massimi minimi funzione due variabili",
        "convergenza serie armonica",
        "trasformata Laplace funzione gradino",
        "determinante matrice 4x4",
        "equazione retta tangente in punto",
        "valore atteso varianza distribuzione normale",
        "dimostra per induzione formula somma",
        "asintoti funzione razionale fratta",
        "spazio vettoriale base ortogonale",
        "matrice diagonalizzabile autovettori distinti",
        "integrale improprio verifica convergenza",
        "norma vettore spazio euclideo",
        "formula di Eulero numeri complessi",
        "prodotto scalare ortogonalità vettori",
        "teorema di Pitagora dimostrazione",
        "probabilità evento complementare Bayes",
        "cambio di base matrice trasformazione",
        "equazione parabola vertice e fuoco",
        "limite successione monotona crescente",
        "integrale per sostituzione trigonometrica",
        "classificazione punti critici hessiana",
    ],
...
BRIDGE_SENTENCES: Dict[Tuple[str, str], List[str]] = {
    ...
    ('coding', 'rights'): [
        ...
        # --- Short-form bridge queries (P2 fix: cls5 anti-degradazione) ---
        "script Python conformità GDPR",
        "codice anonimizzazione dati personali Python",
        "implementa diritto all'oblio nel database",
        "Python cancellazione sicura record utente",
        "GDPR Python automazione compliance",
        "audit trail codice Python normativa",
        "cifratura dati sensibili Python GDPR",
        "calcolo TFR Python D.Lgs",
        "script TFR normativa Python automatico",
        "fattura elettronica Python FatturaPA parser",
        "firma digitale Python X.509 valida",
        "autenticazione SPID Python SAML2",
        "invio PEC Python normativa CAD",
        "smart contract Solidity locazione penale",
        "data masking Python campi sensibili",
        "log digitalmente firmati Python probatori",
        "privacy by design Python architettura",
        "consenso GDPR form Python API",
        "portabilità dati JSON export Python GDPR",
        "data retention automatica Python cancellazione",
        "registro trattamenti Art.30 GDPR Python",
        "scanner licenze open source Python GPL",
        "watermarking steganografico codice sorgente Python",
        "royalties smart contract Solidity streaming",
        "monitoraggio remoto lavoratori Python limiti legali",
        "API busta paga Python CCNL verifica",
        "AI Act audit trail Python registro",
        "bias algoritmico test Python fairness",
        "crittografia end-to-end normativa Python canale",
        "hash chain prove digitali Python immutabile",
        "SHA-256 timestamp documento legale Python",
        "DLP Python esfiltrazione dati aziendali blocco",
        "TLS verifica PCI-DSS script Python",
        "contributi INPS calcolo automatico Python",
        "detrazioni IRPEF calcolo Python busta paga",
        "firma digitale CAdES PAdES verifica Python",
        "conservazione digitale CAD Python metadati",
        "interessi mora D.Lgs 231 Python script",
        "compatibilità licenze dipendenze Python scanner",
        "DSAR export dati JSON Python Flask API",
    ],
    ...
    ('coding', 'math'): [
        ...
        # --- Short-form bridge queries (P2 fix: cls4 anti-degradazione) ---
        "decomposizione LU in Python",
        "SVD con NumPy da zero",
        "autovalori matrice codice Python",
        "gradiente discendente implementazione Python",
        "FFT Python senza librerie esterne",
        "regressione lineare NumPy codice",
        "Runge-Kutta ordine 4 Python",
        "integrale numerico codice trapezi Python",
        "Newton-Raphson implementazione Python radici",
        "matrice inversa codice NumPy",
        "Gram-Schmidt Python ortogonalizzazione",
        "K-means codice Python convergenza",
        "sistema lineare Gauss Python codice",
        "simulazione Monte Carlo Python",
        "convoluzione numerica Python FFT",
        "backpropagation matematica e codice Python",
        "calcola determinante Python codice",
        "fattorizzazione Cholesky Python",
        "filtro Kalman codice Python",
        "ottimizzatore Adam implementazione Python",
        "pseudoinversa Moore-Penrose NumPy",
        "interpolazione Lagrange Python codice",
        "trasformata Fourier discreta Python",
        "stima massima verosimiglianza Python",
        "GMM clustering gaussiano Python",
        "derivata numerica differenze finite Python",
        "t-student test codice Python",
        "catena Markov simulazione Python",
        "entropia Shannon calcolo Python",
        "gradiente coniugato Python sparse",
        "decomposizione QR NumPy codice",
        "simplex algoritmo Python lineare",
        "regressione polinomiale numpy polyfit",
        "correlazione Pearson scipy Python",
        "norma matrice frobenius codice Python",
        "esponenziale matriciale Python calcolo",
        "numero di condizionamento matrice Python",
        "prodotto tensoriale NumPy einsum",
        "campionamento Nyquist Python FFT segnale",
        "varianza stimatore Monte Carlo Python empirica",
    ],
