...
❌ BOTH_ERR
  ...
  followup=True (exp: False) ← WRONG  diff=1 (min atteso: 1) → tier=FALLBACK ✅  conf=0.967
...
❌ DOMAIN_ERR
  ...
  followup=False (exp: False)   diff=3 (min atteso: 3) → tier=PRIMARY ✅  conf=1.000
...
❌ DOMAIN_ERR
  ...
  followup=False (exp: False)   diff=2 (min atteso: 1) → tier=PRIMARY ✅  conf=1.000
...
❌ DOMAIN_ERR
  ...
  followup=False (exp: False)   diff=1 (min atteso: 1) → tier=FALLBACK ✅  conf=1.000
...
❌ DOMAIN_ERR
  → CODING (exp: GENERAL) ← WRONG
  followup=False (exp: False)   diff=2 (min atteso: 1) → tier=PRIMARY ✅  conf=0.614
...
❌ DOMAIN_ERR
  → GENERAL (exp: CODING) ← WRONG
  followup=False (exp: False)   diff=2 (min atteso: 2) → tier=PRIMARY ✅  conf=1.000
